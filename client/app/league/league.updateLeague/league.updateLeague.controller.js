...
angular.module('abroadathletesApp')
    .controller('LeagueUpdateCtrl', function($scope, League, User){
        ...
        User.get().$promise.then(function (me) {
            ...
            League.getLeague(me._id).then(function(result){
                ...
                $scope.leagueUpdate  = result.data;
                $scope.leagueUpdate[0].founded = new Date($scope.leagueUpdate[0].founded);
            });
        });

        $scope.updateLeague = function() {

            League.updateLeague($scope.leagueUpdate[0]).then(function(){
