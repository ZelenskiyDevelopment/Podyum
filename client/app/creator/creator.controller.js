        ...
        switch ($scope.formData.type) {
            ...
            case "team":
                ...
                UserUpdate = {
                    ...
                    president: [{ user: $scope.formData.president._id }],
                    athleticDirector: [{ user: $scope.formData.athleticDirector._id }],
                    headCoach: [{ user: $scope.formData.headCoach._id }],
                    myLeagues:myLeagues,
                    country: $scope.formData.country
                }
            ...
            case "league":
                ...
                UserUpdate = {
                    ...
                    country: $scope.formData.country,
                    completed: true,
                    executive:[{ user: $scope.formData.executive._id }]
                }
