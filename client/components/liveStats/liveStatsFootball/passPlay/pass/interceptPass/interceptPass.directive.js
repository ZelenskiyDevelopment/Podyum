...
angular.module('abroadathletesApp')
  .directive('interceptPass', function () {
    return {
      templateUrl: 'components/liveStats/liveStatsFootball/passPlay/pass/interceptPass/interceptPass.html',
      restrict: 'EA',
      scope: {
        event: '=',
        events: '=',
      ...
      controller: function($scope) {
        ...
        $scope.next = function() {
          if ($scope.event.data.intercept > 0) {
            if ($scope.penalty) {
              $scope.events.push({
